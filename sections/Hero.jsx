...
//     <div className="text-gray-600 body-font md:mx-5 lg:mx-20">
//   <div className="container mx-auto  flex  px-5  pt-20 md:flex-row flex-col items-center md:gap-5">
    

//     <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:px-10 flex flex-col md:items-start md:text-left items-center text-center">
//       <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Validate your sass project idea!</h1>
...
//           <input type="text" id="hero-field" name="hero-field" className="w-full bg-gray-100 rounded border border-gray-300 focus:ring-2 focus:ring-indigo-200 focus:bg-gray-100 focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out z--1"/>
//         </div>
...
//       <img className="object-cover object-center rounded" alt="hero" src="heroo.png"/>
//     </div>
//   </div>
// </div>
