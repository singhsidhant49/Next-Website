...
const Logos = () => {
  return (
    <section className="text-gray-600 body-font overflow-hidden px-3 lg:px-28  pt-16">
      <div className="grid grid-cols-2 gap-10 text-center lg:grid-cols-8">
        <div className="flex items-center justify-center">
          <img src="https://tailus.io/sources/blocks/sass/preview/images/clients/airbnb.svg" alt="Todoist Logo" className="block object-contain h-12" />
        </div>
        <div className="flex items-center justify-center">
          <img src="https://tailus.io/sources/blocks/sass/preview/images/clients/coty.svg" alt="Todoist Logo" className="block object-contain h-12" />
        </div>
        <div className="flex items-center justify-center">
          <img src="https://tailus.io/sources/blocks/sass/preview/images/clients/ge.svg" alt="Todoist Logo" className="block object-contain h-12" />
        </div>
        {/* <div className="flex items-center justify-center">
          <img src="https://www.clipartmax.com/png/middle/217-2178587_cornerstone-random-business-logos.png" alt="Todoist Logo" className="block object-contain h-12" />
        </div> */}
        <div className="flex items-center justify-center">
          <img src="https://jevelin.shufflehound.com/startup-creative/wp-content/uploads/sites/36/2019/11/Sbeauty.png" alt="Todoist Logo" className="block object-contain h-12" />
        </div>
        {/* <div className="flex items-center justify-center">
          <img src="https://tailus.io/sources/blocks/sass/preview/images/clients/airbnb.svg" alt="Todoist Logo" className="block object-contain h-12" />
        </div> */}
