...
const Logos = () => {
  ...
  <div className="grid grid-cols-2 gap-10 text-center lg:grid-cols-8">
    ...
    <div className="flex items-center justify-center">
      <img src="/logos/campfire.svg" alt="Campfire Logo" className="block object-contain h-12" />
    </div>
    <div className="flex items-center justify-center">
      <img src="/logos/android.svg" alt="Android Logo" className="block object-contain h-12" />
    </div>
    <div className="flex items-center justify-center">
      <img src="/logos/atlassian.svg" alt="Atlassian Logo" className="block object-contain h-12" />
    </div>
    <div className="flex items-center justify-center">
      <img src="/logos/apple.svg" alt="Apple Logo" className="block object-contain h-12" />
    </div>
    <div className="flex items-center justify-center">
      <img src="/logos/google.svg" alt="Google Logo" className="block object-contain h-12" />
    </div>
    <div className="flex items-center justify-center">
      <img src="/logos/zeplin.svg" alt="Zeplin Logo" className="block object-contain h-12" />
    </div>
    <div className="flex items-center justify-center">
      <img src="/logos/visual-studio-code.svg" alt="VSCode Logo" className="block object-contain h-12" />
    </div>
    <div className="flex items-center justify-center">
      <img src="/logos/ycombinator.svg" alt="Ycombinator Logo" className="block object-contain h-12" />
    </div>
  </div>
